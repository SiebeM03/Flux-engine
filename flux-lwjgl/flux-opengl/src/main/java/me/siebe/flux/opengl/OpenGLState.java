...
public class OpenGLState {
    ...
    public static void init() {
        ...
        initialized = true;
        createCapabilities();
        addDataToStartupBanner();
    }

    private static void addDataToStartupBanner() {
        Map<String, String> hardwareProperties = StartupBanner.getSection("Hardware").properties();
        hardwareProperties.put("GPU Name", glGetString(GL_RENDERER));

        StartupBanner.addSection(new OpenGLInfoProvider().provide());
    }
